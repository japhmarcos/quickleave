...
trait AuthenticatesAndRegistersUsers {
	...
	public function redirectPath()
	{
		...
		elseif((Auth::user()->role) == 'director')
			return property_exists($this, 'redirectTo') ? $this->redirectTo : 'director';
		elseif((Auth::user()->role) == null) {
			Session::flash('message', "You have successfully registered! To log in, please wait for the confirmation of your membership request.");
